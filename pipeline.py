...
LUA_SHA1 = get_hash(os.path.join(CWD, 'tjournal.lua'))
...
class WgetArgs(object):
    ...
    def realize(self, item):
        wget_args = [
            ...
            '--timeout', '30',
            '--tries', 'inf',
            '--domains', 'tjournal.ru,vc.ru,dtf.ru',
            '--span-hosts',
            '--waitretry', '30',
        ...
        for item_name in item['item_name'].split('\0'):
            ...
            item_type, item_site, item_value = item_name.split(':', 2)
            if item_type == 'post':
